...
print(my_first_name, my_last_name,'I was born in',my_year_of_birth)
#       - first name last name -was born in- year of birth. first name -enjoyed celebrating- current year
print(my_first_name, my_last_name,'I was born in',my_year_of_birth, '.',my_first_name,'enjoyed celebrating',current_year)
